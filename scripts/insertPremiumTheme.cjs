// Script untuk Memasukkan Tema "Premium Emas" ke Database GAS
const fs = require('fs');

const VITE_API_URL = "https://script.google.com/macros/s/AKfycbwwACKPA1WtsEvRFU60oVDm8Edk6j3LQJIPbnV-gIZ0gBQHCqzMRcXm-L_XlmQA7y25/exec";

const htmlTemplate = `
<div class="premium-theme text-gray-800 bg-gray-50">
    <!-- WELCOME PAGE (Only shown before open, controlled by React) -->
    <!-- Note: React controls Cover visiblity in InvitationPage.tsx but for custom themes, we MUST provide our own cover! -->
    <!-- Ah wait! ThemeWrapper renders raw HTML and only hides cover if isOpened == true? NO. ThemeWrapper does NOT have a cover. Theme wrapper rendern ALL raw HTML, user needs to handle hiding the cover using z-index or JS! -->

    <div id="theme-cover" class="uk-position-cover uk-flex uk-flex-center uk-flex-middle uk-background-cover uk-light" style="z-index: 100; position: fixed; background-image: url('{{photo_hero_cover}}');">
        ...
        <div class="uk-position-relative uk-text-center uk-animation-fade uk-padding">
            <h4 class="uk-margin-remove-bottom" style="font-family: 'Playfair Display', serif; color: #D4AF37;">The Wedding Of</h4>
            <h1 class="uk-heading-medium uk-margin-small-top" style="font-family: 'Playfair Display', serif;">{{groom_name}} & {{bride_name}}</h1>
    ...
    <div id="main-content" style="display: none; height: 100vh; overflow-y: auto;">
        ...
        <section class="uk-section uk-section-large uk-background-cover uk-light uk-flex uk-flex-middle" style="min-height: 100vh; background-image: url('{{photo_background}}');">
            <div class="uk-position-cover" style="background-color: rgba(0,0,0,0.5);"></div>
            <div class="uk-container uk-position-relative uk-text-center" uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 200">
                <p class="uk-text-large uk-text-italic mb-2" style="font-family: 'Playfair Display', serif; color: #D4AF37;">{{kalimat_pembuka}}</p>
                ...
                <h1 class="uk-heading-small uk-margin-medium-top" style="font-family: 'Playfair Display', serif;">{{groom_name}} <span style="font-size: 0.5em; color: #D4AF37;">&</span> {{bride_name}}</h1>
                ...
                <div class="uk-child-width-1-1 uk-child-width-1-2@s" uk-grid>
                    <div uk-scrollspy="cls: uk-animation-slide-left-small; delay: 200">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            <h3 class="uk-card-title uk-text-bold" style="font-family: 'Playfair Display', serif;">{{groom_name}}</h3>
                            <p class="uk-text-small uk-margin-remove-bottom">Putra dari</p>
                            <p class="uk-text-bold uk-margin-remove-top">Bpk. {{nama_bapak_laki_laki}} & Ibu {{nama_ibu_laki_laki}}</p>
                            <a href="https://instagram.com/{{ig_laki_laki}}" target="_blank" class="uk-icon-button" style="color: #D4AF37; border-color:#D4AF37;" uk-icon="instagram"></a>
                        </div>
                    </div>
                    <div uk-scrollspy="cls: uk-animation-slide-right-small; delay: 300">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            <h3 class="uk-card-title uk-text-bold" style="font-family: 'Playfair Display', serif;">{{bride_name}}</h3>
                            <p class="uk-text-small uk-margin-remove-bottom">Putri dari</p>
                            <p class="uk-text-bold uk-margin-remove-top">Bpk. {{nama_bapak_perempuan}} & Ibu {{nama_ibu_perempuan}}</p>
                            <a href="https://instagram.com/{{ig_perempuan}}" target="_blank" class="uk-icon-button" style="color: #D4AF37; border-color:#D4AF37;" uk-icon="instagram"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="uk-section uk-section-default uk-background-cover" style="background-image: url('{{photo_story_photo}}'); background-attachment: fixed;">
            <div class="bg-overlay" style="background-color: rgba(255,255,255,0.9); padding: 60px 0;">
                <div class="uk-container uk-container-small uk-text-center" uk-scrollspy="cls: uk-animation-scale-up; delay: 200">
                    <h2 style="font-family: 'Playfair Display', serif; color: #D4AF37;">Menuju Hari Bahagia</h2>
                    <div id="countdown" class="uk-grid-small uk-child-width-auto uk-margin-medium-top uk-flex-center" uk-grid>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body countdown-box">
                                <div class="uk-countdown-number uk-countdown-days" style="color: #D4AF37;"></div>
                                <div class="uk-countdown-label uk-text-small">Hari</div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body countdown-box">
                                <div class="uk-countdown-number uk-countdown-hours" style="color: #D4AF37;"></div>
                                <div class="uk-countdown-label uk-text-small">Jam</div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body countdown-box">
                                <div class="uk-countdown-number uk-countdown-minutes" style="color: #D4AF37;"></div>
                                <div class="uk-countdown-label uk-text-small">Menit</div>
                            </div>
                        </div>
                        <div>
                            <div class="uk-card uk-card-default uk-card-body countdown-box">
                                <div class="uk-countdown-number uk-countdown-seconds" style="color: #D4AF37;"></div>
                    ...
                    <!-- RSVP FORM -->
                    <div class="uk-card uk-card-default uk-card-body uk-margin-large-top uk-box-shadow-large" style="border-top: 4px solid #D4AF37; border-radius: 12px;">
                ...
                <div class="uk-grid-match uk-child-width-1-2@m uk-margin-large-top" uk-grid>
                    ...
                    <div uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 100">
                        <div class="uk-card uk-card-default uk-card-body" style="border-radius: 12px;">
                            ...
                            <h3 class="uk-card-title uk-margin-small-top" style="font-family: 'Playfair Display', serif;">Akad Nikah</h3>
                            ...
                            {{#if akad_map}}
                            <a href="{{akad_map}}" target="_blank" class="uk-button uk-button-default uk-border-pill uk-margin-small-top" style="color:#D4AF37; border-color:#D4AF37;">
                    ...
                    <div uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 200">
                        <div class="uk-card uk-card-default uk-card-body" style="border-radius: 12px; border: 2px solid #D4AF37;">
                            <i class="ri-goblet-line" style="font-size: 3rem; color: #D4AF37;"></i>
                            <h3 class="uk-card-title uk-margin-small-top" style="font-family: 'Playfair Display', serif;">Resepsi</h3>
                            ...
                            {{#if resepsi_map}}
                            <a href="{{resepsi_map}}" target="_blank" class="uk-button uk-button-primary uk-border-pill uk-margin-small-top" style="background-color:#D4AF37; border-color:#D4AF37;">
                                <i class="ri-map-pin-line"></i> Google Maps
                            </a>
                            {{/if}}
                        </div>
        ...
        {{#if live_streaming}}
        <section class="uk-section uk-section-primary" style="background-color: #1a1a1a;">
            <div class="uk-container uk-container-small uk-text-center">
                ...
                <a href="{{live_streaming.url}}" target="_blank" class="uk-button uk-button-danger uk-border-pill uk-margin-top">Tonton Live Sekarang</a>
            </div>
        </section>
        {{/if}}
        ...
        <section class="uk-section uk-section-default">
            <div class="uk-container uk-container-small">
                <h2 class="uk-text-center" style="font-family: 'Playfair Display', serif; color: #D4AF37;">Love Story</h2>
                <div class="uk-margin-large-top">
                    {{#each timeline_kisah}}
                    <div class="uk-card uk-card-default uk-card-body uk-margin-bottom" style="border-left: 4px solid #D4AF37;" uk-scrollspy="cls: uk-animation-fade; delay: 100">
                        <h4 class="uk-margin-remove-bottom" style="color: #D4AF37; font-family: 'Playfair Display', serif;">{{this.tanggal}}</h4>
        ...
        <section class="uk-section uk-section-muted">
            <div class="uk-container uk-container-xlarge">
                <h2 class="uk-text-center uk-margin-large-bottom" style="font-family: 'Playfair Display', serif; color: #D4AF37;">Galeri Foto</h2>
                <div class="uk-child-width-1-2 uk-child-width-1-3@m" uk-grid uk-lightbox="animation: slide">
                    {{#each galleries}}
                    <div>
                        <a class="uk-inline" href="{{this.url}}" data-caption="Gallery">
                            <div class="uk-background-cover" style="background-image: url('{{this.url}}'); height: 300px; border-radius: 8px;"></div>
                        </a>
                    </div>
                    {{/each}}
                </div>
        ...
        <section class="uk-section uk-section-default uk-text-center">
            <div class="uk-container uk-container-small">
                ...
                <form id="custom-wish-form" class="uk-margin-medium-top uk-text-left uk-card uk-card-default uk-card-body" style="border-radius: 12px; border-top: 4px solid #D4AF37;">
                    <div class="uk-margin">
                ...
                <!-- List of Wishes (Loaded dynamically via JS) -->
                <div id="wishes-list" class="uk-margin-large-top uk-text-left" style="max-height: 400px; overflow-y: auto; padding-right: 15px;">
                    <!-- Javascript will append items here -->
                    <p class="uk-text-center uk-text-muted" id="wishes-loading">Memuat ucapan...</p>
                </div>
            </div>
        </section>
        ...
        <section class="uk-section uk-section-muted uk-text-center">
            <div class="uk-container uk-container-small">
                ...
                <p>Doa restu Anda merupakan karunia yang sangat berarti. Jika Anda ingin memberikan tanda kasih berupa kado/amplop digital, dapat dikirimkan melalui:</p>
                <div class="uk-grid-small uk-child-width-1-2@m uk-margin-medium-top uk-flex-center" uk-grid>
                    {{#if nama_bank_1}}
                    <div uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 100">
                        <div class="uk-card uk-card-default uk-card-body" style="border-radius: 12px;">
                            <h3 class="uk-card-title uk-text-bold mb-0">{{nama_bank_1}}</h3>
                    ...
                    <div uk-scrollspy="cls: uk-animation-slide-bottom-small; delay: 200">
                        <div class="uk-card uk-card-default uk-card-body" style="border-radius: 12px;">
                            <h3 class="uk-card-title uk-text-bold mb-0">{{nama_bank_2}}</h3>
        ...
        <!-- SECTION 9: PENUTUP -->
        <section class="uk-section uk-section-large uk-background-cover uk-light uk-text-center" style="background-image: url('{{photo_closing}}'); min-height: 50vh;">
            <div class="uk-position-cover" style="background-color: rgba(0,0,0,0.6);"></div>
            <div class="uk-position-relative uk-container uk-container-small">
                <p class="uk-text-large uk-text-italic" style="font-family: 'Playfair Display', serif;">{{kalimat_penutup}}</p>
                <h2 class="uk-margin-medium-top" style="font-family: 'Playfair Display', serif; color: #D4AF37;">{{groom_name}} & {{bride_name}}</h2>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Ambil VITE_API_URL dari environment/document context jika bisa, atau ambil slug dari URL.
    // Karena JS dieksekusi di context window React, kita bisa ambil location URL untuk tau slug.
    const urlParts = window.location.pathname.split('/');
    const slug = urlParts[urlParts.length - 1];
    
    // Karena VITE_API_URL hanya ada di .env (tidak exposed global), backend form harus ditembak ke API_URL.
    // Tapi wait, jika script dijalankan on-client, VITE_API_URL React dikompilasi. 
    // Trick: React mempublish publicApi, tapi untuk akses dari custom theme, kita fetch langsung ke GAS App.
    ...
    fetch(GAS_URL, {
        method: 'POST',
        body: JSON.stringify({ action: 'getPublicInvitation', slug: slug })
    }).then(r => r.json()).then(res => {
        const list = document.getElementById('wishes-list');
        const loading = document.getElementById('wishes-loading');
        if(list && res.success && res.data.wishes) {
            loading.style.display = 'none';
            if (res.data.wishes.length === 0) {
                list.innerHTML = '<p class="uk-text-center uk-text-muted">Belum ada ucapan, jadilah yang pertama!</p>';
            } else {
                let html = '';
                res.data.wishes.forEach(w => {
                    html += '<div class="wish-card"><div class="wish-card-header"><div class="avatar-circle">'+w.guest_name.charAt(0).toUpperCase()+'</div><span>'+w.guest_name+'</span></div><p class="uk-margin-small-top uk-text-small">'+w.message+'</p></div>';
                });
                list.innerHTML = html;
            }
        } else if (loading) {
            loading.innerText = 'Gagal memuat ucapan.';
        }
    }).catch(e => {
        const loading = document.getElementById('wishes-loading');
    ...
    // 4. Countdown Timer - Ambil target dari React/HTML atau set static untuk {{wedding_date}} target
    // Namun kita bisa membaca elemen "{{wedding_date}}" atau DOM untuk parse tanggal target,
    // Di template ini, kita asumsikan target di dapat dari var template, tapi kita tidak bisa compile JS dengan Handlebars {{}}.
    // Oops, Wait, template Parser is applied to HTML string *and JS string*? 
    // Check ThemeWrapper and InvitationPage: "jsBase = activeTheme.js_template"
    // No, parseTemplate ONLY applied to HTML in InvitationPage.tsx line 512: "renderedHtml = parseTemplate(renderedHtml, dataContext);"
    // Oh! activeTheme.js_template is NOT parsed! 
    // Jadi JS tidak tau {{wedding_date}}. Kita parse dari konten HTML saja. 
    // Let's assume the component mounts and we fetch details from GetPublicInvitation API again (already done above)
});
`;

// Axios is needed to make the request to deploy the theme.
...
async function insertTheme() {
    try {
        ...
        const payload = {
            ...
            name: "Premium Emas",
            plan_type: "premium",
            html_template: htmlTemplate.replace(/\n\s*/g, ' '), // minify HTML slightly
            css_template: cssTemplate,
            js_template: jsTemplate,
            flag_draft: false,
            // image_types needed for this default template to allow uploading dynamic elements
            image_types: ["hero_cover", "groom_photo", "bride_photo", "background", "closing", "story_photo", "gallery"]
        };

        console.log("Sending POST request to VITE_API_URL...");
        
        const response = await axios.post(VITE_API_URL, JSON.stringify(payload), {
            headers: {
                'Content-Type': 'text/plain' // Must use text/plain for GAS post cors bypass
            }
        });
        ...
        if(response.data && response.data.success) {
            console.log("SUKSES! Tema 'Premium Emas' telah ditambahkan ke database GAS!");
        } else {
            console.log("GAGAL:", response.data.message);
        }
    } catch (error) {
        console.error("Error submitting theme:", error.message);
    }
}
