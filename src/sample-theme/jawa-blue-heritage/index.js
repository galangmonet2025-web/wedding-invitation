/* =========================================================================
 ...
 - NEVER call audio.play() and NEVER mirror the play/pause icon — the host
 owns the real player AND is the only writer of the icon (see the MUSIC
 ICON note below). We only keep #btn-toggle-music for the host to intercept.
 ========================================================================= */
(function () {
 'use strict';
