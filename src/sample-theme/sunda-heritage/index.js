/* =========================================================================
 SUNDA HERITAGE — theme JS
 Sundanese palette (ivory / warm gold / tanned brown) with the siger,
 motif bands & marigold-orchid botanicals. Structure/host-wiring cloned from
...
(function () {
 ...
 if (typeof window.__sundaCleanup === 'function') {
 try { window.__sundaCleanup(); } catch (e) { /* noop */ }
 }
 var cleanupFns = [];
 window.__sundaCleanup = function () {
 ...
 // =====================================================================
 // Countdown — reads the REAL wedding date from the DB (#sn-wed-date).
 // Self-contained + guards against stacked intervals on re-execution.
 // =====================================================================
 (function startCountdown() {
 if (window.__snCountdownTimer) {
 clearInterval(window.__snCountdownTimer);
 window.__snCountdownTimer = null;
 }

 function resolveDay() {
 var holder = document.getElementById('wedding-calendar')
 || document.getElementById('sn-wed-date');
 ...
 var holder = document.getElementById('sn-jam-resepsi');
 ...
 clearInterval(window.__snCountdownTimer); window.__snCountdownTimer = null;
 } else {
 ...
 tick();
 window.__snCountdownTimer = setInterval(tick, 1000);
 cleanupFns.push(function () {
 if (window.__snCountdownTimer) { clearInterval(window.__snCountdownTimer); window.__snCountdownTimer = null; }
 });
 })();
